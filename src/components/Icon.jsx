 ...
 * Provides consistent styling and easy maintainability
 */
...
const ICONS = {
  ...
  sparkles: (
    <>
      ...
      <path d="M12 6l1.29 2.61L16 9.9l-2.71.39L12 13l-1.29-2.71L8 9.9l2.71-.39z" />
    </>
  ),
};

/**
 * Icon component that renders consistent SVG icons
 * @param {Object} props
 * @param {string} props.name - Icon name from ICONS object
 * @param {string} props.className - Additional CSS classes
 * @param {string} props.color - Fill color (defaults to currentColor for CSS control)
 * @param {number} props.size - Size in pixels (defaults to 24)
 * @param {string} props.alt - Alternative text for accessibility
 */
export default function Icon({ name, className = '', color = 'currentColor', size = 24, alt = '' }) {
